...
int main(void) {
	...
	Lcd_init(&Display);
	SPI_Addr=(MEMS_WHO_AM_I | MEMS_RW) & (~MEMS_MS);
	...
	while (1) {
		//TODO MEMS SPI data polling


		//TODO LED lightning rely on a MEMS data
...
static void MX_GPIO_Init(void) {
	...
	HAL_GPIO_WritePin(GPIOD,
			LED1_Pin | LED2_Pin | LED3_Pin | LED4_Pin | GPIO_PIN_0 | GPIO_PIN_1
					| GPIO_PIN_2 | GPIO_PIN_3 | GPIO_PIN_4 | GPIO_PIN_5
					| GPIO_PIN_6 | GPIO_PIN_7, GPIO_PIN_RESET);

	/*Configure GPIO pin Output Level */
	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_4 | GPIO_PIN_5 | GPIO_PIN_7,
			GPIO_PIN_RESET);
	...
	/*Configure GPIO pins : LED1_Pin LED2_Pin LED3_Pin LED4_Pin
	 PD0 PD1 PD2 PD3
	 PD4 PD5 PD6 PD7 */
	GPIO_InitStruct.Pin = LED1_Pin | LED2_Pin | LED3_Pin | LED4_Pin | GPIO_PIN_0
